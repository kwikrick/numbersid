...
// reused functions for ui_parameters.h and ui_variables.h and ui_sinebobs.h
...
static void _ui_numbersid_draw_menu(ui_numbersid_t* ui) {
    ...
    if (ImGui::BeginMainMenuBar()) {
        ...
        if (ImGui::BeginMenu("Sequencer")) {
            ...
            ImGui::MenuItem("Sinebobs", 0, &ui->ui_sinebobs.open);
...
void ui_numbersid_init(ui_numbersid_t* ui, const ui_numbersid_desc_t* ui_desc) {
    ...
    x += dx; y += dy;
    {
        ui_parameters_desc_t desc = {0};
        desc.title = "Parameters";
        desc.sequencer = ui_desc->sequencer;
        desc.x = x;
        desc.y = y;
        desc.open = true;
     ...
     x += dx; y += dy;
    {
        ui_sinebobs_desc_t desc = {0};
        desc.title = "Sinebobs";
        desc.sequencer = ui_desc->sequencer;
        desc.x = x;
        desc.y = y;
        desc.open = true;
        ui_sinebobs_init(&ui->ui_sinebobs, &desc);
    }
    x += dx; y += dy;
    {
        ui_variables_desc_t desc = {0};
        desc.title = "Variables";
        desc.sequencer = ui_desc->sequencer;
        desc.x = x;
        desc.y = y;
        desc.open = true;
        ui_variables_init(&ui->ui_variables, &desc);
    }
    x += dx; y += dy;
    {
...
void ui_numbersid_discard(ui_numbersid_t* ui) {
    ...
    ui_sinebobs_discard(&ui->ui_sinebobs);
...
void ui_numbersid_draw(ui_numbersid_t* ui, const ui_display_frame_t* frame) {
    ...
    ui_sinebobs_draw(&ui->ui_sinebobs);
...
void ui_numbersid_save_settings(ui_numbersid_t* ui, ui_settings_t* settings) {
    ...
    ui_sinebobs_save_settings(&ui->ui_sinebobs, settings);
...
void ui_numbersid_load_settings(ui_numbersid_t* ui, const ui_settings_t* settings) {
    ...
    ui_sinebobs_load_settings(&ui->ui_sinebobs, settings);
