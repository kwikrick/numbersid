...
/*#
    ...
    All strings provided to ui_soundcontrol_init() must remain alive until
    ui_soundcontrol_discard() is called!
...
/* setup parameters for ui_soundcontrol_init()
    NOTE: all string data must remain alive until ui_soundcontrol_discard()!
*/
typedef struct ui_soundcontrol_desc_t {
...
} ui_soundcontrol_desc_t;

typedef struct ui_soundcontrol_t {
    const char* title;
...
void ui_soundcontrol_init(ui_soundcontrol_t* win, const ui_soundcontrol_desc_t* desc);
void ui_soundcontrol_discard(ui_soundcontrol_t* win);
void ui_soundcontrol_draw(ui_soundcontrol_t* win);
void ui_soundcontrol_save_settings(ui_soundcontrol_t* win, ui_settings_t* settings);
void ui_soundcontrol_load_settings(ui_soundcontrol_t* win, const ui_settings_t* settings);
...
void ui_soundcontrol_init(ui_soundcontrol_t* win, const ui_soundcontrol_desc_t* desc) {
    ...
    memset(win, 0, sizeof(ui_soundcontrol_t));
...
static void _ui_soundcontrol_draw_state(ui_soundcontrol_t* win) {
...
void ui_soundcontrol_draw(ui_soundcontrol_t* win) {
    ...
    if (ImGui::Begin(win->title, &win->open)) {
        ...
        _ui_soundcontrol_draw_state(win);
        ImGui::EndChild();
    }
    ImGui::End();
}
