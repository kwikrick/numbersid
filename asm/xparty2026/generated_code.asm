...
variable_changed_81:
   ...
   Apply_Variable_To_Global_Parameter(81, Global_Param_bob_color)
   rts
variable_changed_65:
...
variable_changed_77:
   ...
   rts
variable_changed_72:
   Apply_Variable_To_Sine_Parameter(72, 0, Sine_Param_freq)
   rts
variable_changed_73:
   Apply_Variable_To_Sine_Parameter(73, 1, Sine_Param_freq)
   rts
